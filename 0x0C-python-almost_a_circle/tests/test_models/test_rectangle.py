#!/usr/bin/python3
"""
Unittest for My Rectangle Class
# command: run with python3 -m unittest discover tests
# command: run with python3 -m unittest tests/test_models/test_rectangle.py
"""
